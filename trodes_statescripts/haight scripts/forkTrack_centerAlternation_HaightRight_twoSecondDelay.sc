% PROGRAM NAME: 	Fork track center alternation with two second delay. Right side of Haight. Oct 2020.
% AUTHOR: 		JAG
...
callback portin[24] down % set lastWell to handle
	lastWell=handleWell
end
