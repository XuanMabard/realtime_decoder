% PROGRAM NAME: 	Fork track handle alternation with two second delay. Right side of Haight. Oct 2020.
% AUTHOR: 		JAG
...
callback portin[22] up
	disp('right_poke')
	currWell=rightWell
	trigger(3) % reward if first poke at side arm under conditions
