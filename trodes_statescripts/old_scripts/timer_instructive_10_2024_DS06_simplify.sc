...
%function 6 % end lockout and reactivate back
%	disp('WHITENOISE')	
%	do in lockoutPeriod
%		disp('LOCKEND')
%	end
...
callback portin[7] up % center well
	...
	else if (taskstate == 2 && trialtype == 1 && reward_available_out_if_poke == 1 && reward_available_at_center == 0) do
		disp('NEXT_TRIAL')
	...
	else if (taskstate == 2 && trialtype == 1 && reward_available_at_center == 0 && decision_timeout == 1 ) do 
