...
int deliverPeriodOuter= 300   		% how long to deliver the reward at outer wells, 150 uL - 400; 100uL - 275
int lockoutPeriod_timeout= 10000 			% length of lockout after not going to the outer arm after a beep
int lockoutPeriod_centerReward = 8000 %(DS) now, python file determines this value
