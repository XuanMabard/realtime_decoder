...
function 14
	...
	if (content_trials_finish == 1 || contentReward >= content_trials_limit) do
		taskstate = 3
		disp('TASKSTATE3')
	else if (trialtype == 1 && target_location == 1 && content_generation_avail == 1) do
	%else do
		contentTrialCount = contentTrialCount + 1
		disp('start content trial of target arm 1')
		disp('BEEP3')
		portout[7] = 0
		portout[9] = 1
...
function 6 % ARM 2 shortcut message
	...
	if (content_trials_finish == 1 || contentReward >= content_trials_limit) do
		taskstate = 3
		disp('TASKSTATE3')
	else if (trialtype == 1 && target_location == 2 && content_generation_avail == 1) do
	%else do
		contentTrialCount = contentTrialCount + 1
		disp('start content trial of target arm 2')
		disp('BEEP3')
		portout[7]  = 0
		portout[15] = 1
