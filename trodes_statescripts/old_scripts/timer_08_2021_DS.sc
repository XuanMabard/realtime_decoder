...
int content_trials_time_limit = 1800000		% box time 1800000 = 30min, 1200000 = 20min; (DS) the task state 2 will end within this time limit 
int reward_avail_wait = 3000				% reward window -- time for nose poking to get reward after the beep sound
int content_trials_limit = 40 % (DS) task state 2 will end if the rat gets 40 rewards
