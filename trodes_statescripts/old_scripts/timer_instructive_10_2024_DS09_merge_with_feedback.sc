...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
int TrialforDecision = 100 %(DS) from this trial, start decision trial. for guided, make it 100; for decision, make it 0
...
int content_trials_time_limit = 1800000		% box time 2400000 = 40 min; 1800000 = 30min, 1200000 = 20min
...
callback portin[7] up % center well
	...
	% taskstate == 2
		...
		% other 
			...
			if (reward_available_out_if_poke == 1) do% && content_generation_avail == 1) do
				disp('NEXT_TRIAL')
