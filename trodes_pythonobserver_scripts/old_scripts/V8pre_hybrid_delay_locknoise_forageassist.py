...
def chooseGoal():    # this is only called when numgoals ==1. to assist forage, choose 2 goals; first encountered will turn into only goal
    ...
    #outerReps = np.random.randint(4,11) 
...
trialtype = 0
outerReps = 15
#outerReps = np.random.randint(4,11) #10
print("SCQTMESSAGE: disp('outerreps = "+str(outerReps)+"');\n") 
...
#waitdist = [5000, 5000, 6000, 6000, 7000, 7000, 7000, 7000]
waitdist = [5500, 5500, 6000, 7000, 8000, 8000, 9000, 9000]

startwaitdist = [1000, 3000, 2000]
